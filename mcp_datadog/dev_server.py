...
def _register_tool(name: str, description: str, handler, category: str) -> None:
...
# Tool registrations (same as server.py)
_register_tool("query-metrics", "Query time-series metric data from Datadog.", query_metrics, "metrics")
_register_tool("get-metrics", "Search for available Datadog metrics by name pattern.", get_metrics, "metrics")
_register_tool("get-metric-metadata", "Get metadata for a specific Datadog metric.", get_metric_metadata, "metrics")
_register_tool("list-active-metrics", "List active metrics from a given time.", list_active_metrics, "metrics")
_register_tool("list-metric-tags", "List tags for a specific metric.", list_metric_tags, "metrics")

_register_tool("get-monitors", "List Datadog monitors with optional filtering.", get_monitors, "monitors")
_register_tool("get-monitor", "Get detailed information about a specific Datadog monitor.", get_monitor, "monitors")
...
_register_tool("get-service-dependencies", "Get service dependencies.", get_service_dependencies, "apm")
_register_tool("get-all-service-dependencies", "Get all service dependencies.", get_all_service_dependencies, "apm")

_register_tool("list-synthetics", "List synthetics tests.", list_synthetics, "synthetics")
_register_tool("get-synthetics-result", "Get synthetics test results.", get_synthetics_result, "synthetics")
_register_tool("trigger-synthetics", "Trigger synthetics tests.", trigger_synthetics, "synthetics")
_register_tool("create-synthetics-test", "Create a synthetics test.", create_synthetics_test, "synthetics")
_register_tool("update-synthetics-test", "Update a synthetics test.", update_synthetics_test, "synthetics")
_register_tool("delete-synthetics-test", "Delete a synthetics test.", delete_synthetics_test, "synthetics")
...
_register_tool("create-fleet-deployment-configure", "Create fleet deployment.", create_fleet_deployment_configure, "fleet")
_register_tool("cancel-fleet-deployment", "Cancel a fleet deployment.", cancel_fleet_deployment, "fleet")

_register_tool("list-error-trackers", "List error trackers.", list_error_trackers, "error_tracking")
_register_tool("get-error-tracker", "Get error tracker details.", get_error_tracker, "error_tracking")
